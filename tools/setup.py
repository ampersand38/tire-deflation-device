...
def main():
    ...
    print("""
  ######################################
  # TDD Development Environment Setup #
  ######################################

  This script will create your TDD dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your TDD project folder:
    [Arma 3 installation directory]\\{} => TDD project folder
    P:\\{}                              => TDD project folder
